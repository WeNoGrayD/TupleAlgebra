...
{
    public abstract class NonFictionalAttributeComponentExceptionOperator<TData, CTOperand1>
        ...
        where CTOperand1 : NonFictionalAttributeComponent<TData>
    {
        ...
        public AttributeComponent<TData> Accept(
            ...
            AttributeComponentFactory factory)
        {
            return factory.CreateEmpty<TData>(new AttributeComponentFactoryArgs());
        }
    }
}
