...
{
    public interface IFactoryUnaryAttributeComponentAcceptor<TData, TIntermediateResult, in CTOperand, in TFactory, in TFactoryArgs, out TOperationResult>
    ...
    public interface IFactoryBinaryAttributeComponentAcceptor<TData, TIntermediateResult, in TOperand1, in CTOperand1, in TOperand2, in TFactory, in TFactoryArgs, out TOperationResult>
    ...
    public interface IFactoryBinaryAttributeComponentAcceptor<TData, TIntermediateResult, in CTOperand1, in TOperand2, in TFactory, in TFactoryArgs, out TOperationResult>
        : IFactoryBinaryAttributeComponentAcceptor<TData, TIntermediateResult, CTOperand1, CTOperand1, TOperand2, TFactory, TFactoryArgs, TOperationResult>
