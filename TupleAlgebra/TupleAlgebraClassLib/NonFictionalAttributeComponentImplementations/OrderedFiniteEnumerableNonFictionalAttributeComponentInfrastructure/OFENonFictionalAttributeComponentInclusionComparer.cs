...
{
    public sealed class OrderedFiniteEnumerableNonFictionalAttributeComponentInclusionComparer<TValue>
    ...
    {
        public bool Accept(OrderedFiniteEnumerableNonFictionalAttributeComponent<TValue> greater,
