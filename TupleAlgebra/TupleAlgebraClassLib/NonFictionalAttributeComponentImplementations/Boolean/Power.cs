          ...
          IFiniteEnumerableAttributeComponentPower
    {
            ...
            AttributeComponent<TData> ac2)
        {
            if (second is AtomicNonFictionalAttributeComponentPower second2)
                ...
                throw new InvalidCastException("Непустая атомная компонента сравнивается с непустой компонентой другого вида, в данный момент эта операция не поддерживается.");
        }
