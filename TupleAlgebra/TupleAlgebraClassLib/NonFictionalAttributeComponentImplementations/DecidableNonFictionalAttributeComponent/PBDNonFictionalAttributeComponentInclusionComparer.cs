...
{
    public sealed class PredicateBasedDecidableNonFictionalAttributeComponentInclusionComparer<TValue>
    ...
    {
        public bool Accept(PredicateBasedDecidableNonFictionalAttributeComponent<TValue> greater,
